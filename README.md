...
<head>
    ...
    <style>
        body {
            ...
            background: url('https://assets.onecompiler.app/42r523uca/42y46qzpj/624e50d2bca9c6314160403c2f83bc0c.jpg') no-repeat center center fixed; /* رابط الصورة الجديدة */
        ...
        .container {
            width: 100%;
            max-width: 400px;
            background-color: rgba(255, 255, 255, 0.8); /* إضافة شفافيات لتظهر الخلفية خلف المحتوى */
            padding: 20px;
            border-radius: 10px;
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>&copy; 2024 جميع الحقوق محفوظة. <br> <a 
        </div>
    </div>
</body>
</html>
